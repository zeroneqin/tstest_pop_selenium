...
public class VSModel extends GUIPage {

    
	private VSModel() throws PageException {
	    load();
	}
	

	
	public static VSModel open() throws PageException {
	    return new VSModel();
	}
	...
	public void load() throws PageException {
	    try {
	        ...
	        Logs.caseError("Failed to load virtual service model, exception:"+de.getMessage());
	        throw new PageException("Failed to load virtual service model, exception:"+de.getMessage());
	    }
